...
class Slides extends CI_Controller
{
    ...
    public function save(){
        ...
        if($validate){
            ...
            $image_1191x731 = upload_picture($_FILES["img_url"]["tmp_name"], "uploads/$this->viewFolder",1191,731, $file_name);
            $image_1920x1080 = upload_picture($_FILES["img_url"]["tmp_name"], "uploads/$this->viewFolder",1920,1080, $file_name);
            $image_350x263 = upload_picture($_FILES["img_url"]["tmp_name"], "uploads/$this->viewFolder",350,263, $file_name);

            if($image_1191x731 && $image_1920x1080 && $image_350x263 ){
