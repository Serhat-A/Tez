...
class Portfolio extends CI_Controller
{
    ...
    public function image_upload($id){
        ...
        $image_1170x540 = upload_picture($_FILES["file"]["tmp_name"], "uploads/$this->viewFolder",1170,540, $file_name);
        $image_1080x920 = upload_picture($_FILES["file"]["tmp_name"], "uploads/$this->viewFolder",1080,920, $file_name);
        $image_350x200 = upload_picture($_FILES["file"]["tmp_name"], "uploads/$this->viewFolder",350,200, $file_name);
        $image_540x250 = upload_picture($_FILES["file"]["tmp_name"], "uploads/$this->viewFolder",540,250, $file_name);
        $image_270x230 = upload_picture($_FILES["file"]["tmp_name"], "uploads/$this->viewFolder",270,230, $file_name);

        if($image_1170x540 && $image_350x200 && $image_540x250 &&  $image_270x230 &&  $image_1080x920 ){
