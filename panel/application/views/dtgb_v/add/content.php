<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">
            Yeni Dumlupınar TGB Ekle
        </h4>
    </div><!-- END column -->
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-body">
                <form action="<?php echo base_url("dtgb/save"); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <a href="<?php echo base_url("dtgb"); ?>" class="btn btn-md btn-danger btn-outline">İptal</a>
                </form>
            </div><!-- .widget-body -->
        </div><!-- .widget -->
    </div><!-- END column -->
