    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-body">
                <form action="<?php echo base_url("firmnews/update/$item->id"); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <?php if(isset($form_error)){ ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1 image_upload_container">
                                <img src="<?php get_picture($viewFolder,$item->img_url,"350x217"); ?>" alt="" class="img-responsive">
                            </div>
                    ...
                    <a href="<?php echo base_url("firmnews"); ?>" class="btn btn-md btn-danger btn-outline">İptal</a>
                </form>
            </div><!-- .widget-body -->
        </div><!-- .widget -->
    </div><!-- END column -->
