<div role="main" class="main">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 order-2 order-md-1 align-self-center p-static">
                    <h1 data-title-border>BAŞVURU BELGELERI
                ...
                <div class="col-md-4 order-1 order-md-2 align-self-center">
                    <ul class="breadcrumb d-block text-md-right">
                        ...
                        <li class="active">BAŞVURU BELGELERI
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="container py-2">
        <h3><strong class="font-weight-extra-bold">BAŞVURU BELGELERI
            </strong></h3>


        <?php foreach ($basvurubelge as $item) {?>
            <hr class="solid my-5">
