            ...
            <section class="call-to-action featured featured-tertiary mb-5">
                <div class="col-sm-9 col-lg-9">
                    <div class="call-to-action-content">
                        ...
                        <p class="mb-0"><strong class="font-weight-extra-bold"></strong>
                    </div>
                </div>
                <div class="col-sm-3 col-lg-3">
                    <div class="call-to-action-btn">
                        <a href="<?php echo $item->url; ?>" target="_blank" class="btn btn-modern text-2 btn-tertiary"><img src="<?php echo base_url("assets/")?>img/download.png"/></a>
                    </div>
