                        ...
                        <div class="basic-details">
                            ...
                            <?php foreach ($portfolio_images as $image) { ?>
                                ...
                                <div class="image-column col-lg-6 col-md-12 col-sm-12">
                                    <figure class="image-box"><a href="<?php echo base_url("panel/uploads/portfolio_v/1170x540/$image->img_url");?>" class="lightbox-image" title="Image Caption Here"><img src="<?php echo base_url("panel/uploads/portfolio_v/1170x540/$image->img_url");?>" alt=""></a></figure>
                                </div>
                            <?php } ?>
