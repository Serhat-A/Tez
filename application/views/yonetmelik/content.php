<div role="main" class="main">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 order-2 order-md-1 align-self-center p-static">
                    <h1 data-title-border>TGB YÖNETMELİĞİ
                    </h1>
                </div>
                <div class="col-md-4 order-1 order-md-2 align-self-center">
                    <ul class="breadcrumb d-block text-md-right">
                        <li><a href="<?php echo base_url()?>">Ana Sayfa</a></li>
                        <li class="active">TGB YÖNETMELİĞİ</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="container py-2">
        <h3><strong class="font-weight-extra-bold">TGB Yönetmeliği</strong></h3>


        <?php foreach ($dtgb as $item) {?>
            <hr class="solid my-5">
